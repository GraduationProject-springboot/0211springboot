...
## 1.2目的和意义
球队训练信息管理系统可以对球队训练信息管理系统信息进行集中管理，可以真正避免传统管理的缺陷。球队训练信息管理系统是一款运用软件开发技术设计实现的应用系统，在信息处理上可以达到快速的目的，不管是针对数据添加，数据维护和统计，以及数据查询等处理要求，球队训练信息管理系统都可以轻松应对。所以，球队训练信息管理系统的运用是让球队训练信息管理系统信息管理升级的最好方式。它可以实现信息处理的便利化要求，还可以规范信息处理的流程，让事务处理成为管理人员手中的一件简单事，而不是之前手工处理时的困难事。尽管球队训练信息管理系统具备较完善的功能，但是也需要管理人员利用闲暇时间提升自身素质以及个人能力，在操作球队训练信息管理系统时可以最大化运用球队训练信息管理系统提供的功能，让系统在满足高效率处理数据的同时，也能始终稳定运行，还可以确保数据的可靠性与数据处理的质量。
## 1.3论文结构安排
...
# 第2章 开发环境与技术
开发球队训练信息管理系统需要搭建编程的环境，也需要通过调查，对各个相关技术进行分析，选取适合本系统开发的技术与工具。
## 2.1 MYSQL数据库
...
### 3.1.1操作可行性分析
开发本系统需要用到的工具，本人都比较熟悉，因此可以使用这些工具，完整开发球队训练信息管理系统。此外，球队训练信息管理系统在功能上，基本都是完成信息的处理，涵盖了添加，修改，删除等，而且操作者面对的都是各个功能操作界面，并不是编码后台，所以一般的使用者都可以通过操作界面轻松完成信息的加工处理。因此，本系统操作可行。
### 3.1.2经济可行性分析
...
### 3.1.3技术可行性分析
本系统需要的软件包括Eclipse，Tomcat，Mysql等，这些工具都接触并使用过，至于JAVA，B/S，vue，Html等技术，图书馆都有对应的书籍可以参考学习，加上平时课堂上学习的编程小项目对这些技术都有讲解，另外，本人也从课程设计作业中锻炼了编程能力。所以在技术上，可以完成球队训练信息管理系统的编程开发。

通过上面的分析，已经确定了本系统在经济上的可行，本系统在技术上的可行，本系统在操作上的可行。由此，可以得出在目前的条件下，对于球队训练信息管理系统的设计与实现是可以进行下去的。
## 3.2系统流程分析
...
图3.3 查询信息流程图
## 3.3系统性能分析
分析球队训练信息管理系统对于性能的需求主要还是从下面的5个角度来分析，它们分别是系统的实用性，系统的适应性，系统的易操作性，系统的安全性和系统的易维护性。
...
![C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\公告信息.jpg](/md/blog.005.jpeg "C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\公告信息.jpg")
图4.1 公告信息实体属性图

（2）下图是字典表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\字典表.jpg](/md/blog.006.jpeg "C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\字典表.jpg")
图4.2 字典表实体属性图

（3）下图是教练实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\教练.jpg](/md/blog.007.jpeg "C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\教练.jpg")
图4.3 教练实体属性图

（4）下图是训练进度实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\训练进度.jpg](/md/blog.008.jpeg "C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\训练进度.jpg")
图4.4 训练进度实体属性图

（5）下图是训练计划实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\训练计划.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\训练计划.jpg")
图4.5 训练计划实体属性图

（6）下图是球队信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\球队信息.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\球队信息.jpg")
图4.6 球队信息实体属性图

（7）下图是比赛首发名单实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\比赛首发名单.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\比赛首发名单.jpg")
图4.7 比赛首发名单实体属性图

（8）下图是加入的球队实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\加入的球队.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\加入的球队.jpg")
图4.8 加入的球队实体属性图

（9）下图是球员实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\球员.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\球员.jpg")
图4.9 球员实体属性图

（10）下图是用户表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\用户表.jpg](/md/blog.014.jpeg "C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\用户表.jpg")
图4.10 用户表实体属性图

（11）下图是考勤信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\考勤信息.jpg](/md/blog.015.jpeg "C:\Users\Administrator\Desktop\img\qiuduixunlianxinxi\考勤信息.jpg")
图4.11 考勤信息实体属性图
### 4.3.2 数据库物理设计
...
|3|jiaolian\_phone|String|手机号|是|
|4|jiaolian\_email|String|电子邮箱|是|
|5|jiaolian\_delete|Integer|假删|是|
...
|3|yonghu\_id|Integer|球员|是|
|4|jiarudeqiudui\_number|BigDecimal|工资|是|
...
|3|qiudui\_types|Integer|球队类型|是|
|4|qiudui\_address|String|所属地点|是|
|5|jiaolian\_id|Integer|教练|是|
|6|qiudui\_content|String|球队简介|是|
|7|create\_time|Date|创建时间|是|
表4.6比赛首发名单表
...
|1|Id|Int|id|否|
|2|qiudui\_id|Integer|球队|是|
|3|shoufamingdan\_file|String|名单下载|是|
...
|1|Id|Int|id|否|
|2|qiudui\_id|Integer|球队|是|
|3|xunlianjihua\_name|String|标题|是|
|4|xunlianjihua\_tianshu|String|训练天数|是|
|5|xunlianjihua\_text|String|训练内容|是|
|6|create\_time|Date|创建时间|是|
表4.8训练进度表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|xunlianjihua\_id|Integer|训练计划|是|
|3|yonghu\_id|Integer|球员|是|
|4|xunlianjindu\_text|String|训练进度|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|yonghu\_name|String|球员姓名|是|
|3|yonghu\_phone|String|手机号|是|
